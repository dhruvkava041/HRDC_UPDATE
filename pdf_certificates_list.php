        ...
        <table id="tblCustomers" class="table table-bordered  table-striped">
                ...
                <?php  
                   ...
                   if(!$conn)
                   {
                    ...
                    {
                        $batchno = $_POST['batchnumber'];
                        //$participantname = $_POST['participantname'];
                        //$employeeid = $_POST['employeeid'];

                        $query = "SELECT * FROM `batchwise_nomination` WHERE `Select Batch`='$batchno'";
                        ...
                        while($row = mysqli_fetch_array($query_run))
                        {
                            ?>
                                <tr>
                                    ...
                                    <td class="float-right"><a  class="btn btn-primary "  href = "certificate.php?np=<?php echo $row['Name of Participant'] ?> & fd=<?php echo $row['Functional Department'] ?>&en=<?php echo $row['Event Name'] ?>&sen=<?php echo $row['Subevent Name'] ?>&ei=<?php echo $row['Employee ID'] ?>&mn=<?php echo $row['Mobile Number'] ?>&emi=<?php echo $row['Email Id'] ?>&sb=<?php echo $row['Select Batch'] ?>&ss=<?php echo $row['Select slot'] ?>&ra=<?php echo $row['Report Authority'] ?>&dd=<?php echo $row['Designation'] ?>"><i class="fa fa-edit"></i></a>
                                    </td>
                                </tr>
                            <?php
                        }
