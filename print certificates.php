...
<div class="container">
  <div class="title">Details of certificates</div>
  <form action="print certificates.php" method="POST">
    <p>
 ...
 <div class="input-box">
      ...
      <div class="input-box">
        ...
        $resultSet = $mysqli->query("SELECT DISTINCT `event_batch` from subevent" );
        ?>
